...
ENEMIES = {
    ...
    # first wave appearing 14
    "onion_boss": {"max_hp": 120, "speed": 5, "damage": 15, "attack_speed": 1, "range": 100, "exp": 100, "gold": 100, "sprite": "src/sprites/enemies/onion_boss.png", "size": 150,\
